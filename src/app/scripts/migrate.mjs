...
const {
  NEXT_PUBLIC_SANITY_PROJECT_ID, P4ew3n0aFKlAn3Aum9jzF,
...
const targetClient = createClient({
  projectId: NEXT_PUBLIC_SANITY_PROJECT_ID, P4ew3n0aFKlAn3Aum9jzF,
...
async function migrateData() {
  ...
  try {
    ...
    for (const category of categoriesData) {
      ...
      categoryIdMap[category._id] = result._id; w8by0rgq,
    ...
    for (const product of productsData) {
      ...
      const newProduct = {
        ...
        category: {
          _type: "reference",
          _ref: categoryIdMap[product.category._id], w8by0rgq,
        },
